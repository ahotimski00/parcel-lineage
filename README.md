...
<img src="docs/workflow.png" width="760" alt="parcel-lineage ownership reconciliation workflow: fetch parcels, normalize owner names, reconcile owners, aggregate acreage, rank and map">
...
![Largest private landowners in Hamilton County, NY, after owner-name reconciliation; bars whose owner had multiple names merged are highlighted](docs/hamilton_landowners.png)

<img src="docs/hamilton_owner_map.png" width="480" alt="Map of Hamilton County parcels with the six largest private owners colored, showing how their holdings are distributed across the county">


*Both figures generated by `examples/ny_timberland_plot.py` (`pip install parcel-lineage[viz]`).*
